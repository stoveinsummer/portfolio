...
export default function TeamMakerPage() {
  return <main><SiteHeader active="Tools" /><div className="tool-detail-head"><p className="eyebrow">Tool 04 · Fair random teams</p><h1>Team<br /><i>maker.</i></h1><p>참여자 이름을 입력하고 원하는 기준을 선택해 인원 차이 없이 무작위로 팀을 나눕니다.</p></div><div className="tool-detail-content"><TeamMaker /><Link className="back-link" href="/tools">← 도구 목록</Link></div><SiteFooter /></main>;
}
